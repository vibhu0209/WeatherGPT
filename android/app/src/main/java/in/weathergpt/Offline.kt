...
object Offline {
    ...
    fun answer(text:String,b:BundleDto?,offset:Int,language:String="en"):Pair<String,Int> {
        ...
        if(!weatherWords.any{q.contains(it)}) return (intro+copy(lang,
            ...
            bn="আমি আজ বা আগামীকালের সংরক্ষিত আবহাওয়া দেখাতে পারি। অন্য প্রশ্নের জন্য ইন্টারনেটে যুক্ত হোন।",
            te="నేను ఈరోజు లేదా రేపు సేవ్ చేసిన వాతావరణం చూపగలను. ఇతర ప్రశ్నలకు ఇంటర్నెట్‌కు కనెక్ట్ అవ్వండి.",
            mr="मी आज किंवा उद्याचे जतन हवामान दाखवू शकतो. इतर प्रश्नांसाठी इंटरनेटला जोडा.",
            ta="இன்று அல்லது நாளை சேமித்த வானிலையை காட்ட முடியும். பிற கேள்விகளுக்கு இணையத்துடன் இணையுங்கள்.",
            gu="હું આજે અથવા કાલે સાચવેલું હવામાન બતાવી શકું. અન્ય પ્રશ્નો માટે ઇન્ટરનેટ જોડો.",
            kn="ನಾನು ಇಂದು ಅಥವಾ ನಾಳೆ ಉಳಿಸಿದ ಹವಾಮಾನ ತೋರಿಸಬಲ್ಲೆ. ಇತರ ಪ್ರಶ್ನೆಗಳಿಗೆ ಇಂಟರ್ನೆಟ್ ಸಂಪರ್ಕಿಸಿ.",
            ml="ഇന്ന് അല്ലെങ്കിൽ നാളെ സേവ് ചെയ്ത കാലാവസ്ഥ കാണിക്കാം. മറ്റ് ചോദ്യങ്ങൾക്ക് ഇന്റർനെറ്റ് ബന്ധിപ്പിക്കുക.",
            pa="ਮੈਂ ਅੱਜ ਜਾਂ ਕੱਲ੍ਹ ਦਾ ਸੰਭਾਲਿਆ ਮੌਸਮ ਦਿਖਾ ਸਕਦਾ ਹਾਂ। ਹੋਰ ਸਵਾਲਾਂ ਲਈ ਇੰਟਰਨੈੱਟ ਜੋੜੋ।",
            or="ମୁଁ ଆଜି କିମ୍ବା କାଲିର ସଞ୍ଚିତ ପାଣିପାଗ ଦେଖାଇପାରିବି। ଅନ୍ୟ ପ୍ରଶ୍ନ ପାଇଁ ଇଣ୍ଟରନେଟ୍ ଯୋଡନ୍ତୁ।",
        )) to day
